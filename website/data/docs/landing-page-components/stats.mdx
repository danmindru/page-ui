  ...
  previewComponent={
    <LandingStatsSection
      ...
      stats={[
        ...
        { value: '25+', label: 'awards', description: 'Recognized with 25+ awards and featured in industry publications.' },
...
<ComponentExample
  previewComponent={
    <LandingStatsSection
      ...
      description="We take pride in our accomplishments and the impact we've made across various projects and industries."
      columnsDesktop={3}
      hasBorders={true}
      stats={[
        { value: '150+', label: 'projects', description: 'Over 150 projects successfully delivered.' },
...
<ComponentExample
  previewComponent={
    <LandingStatsSection
      ...
      columnsMobile={1}
      stats={[
        { value: '150+', label: 'projects', description: 'Projects delivered in the last 12 months.' },
        { value: '9', label: 'designers', description: 'That are part of our team.' },
        { value: '30+', label: 'devs', description: 'Developers that we work with.' },
        { value: '25+', label: 'awards', description: 'Industry awards since 2010.' }
      ]}
    />
  }
>
...
<ComponentExample
  previewComponent={
    <div className="grid grid-cols-2 md:grid-cols-3 border-l border-t border-gray-200 dark:border-gray-800">
      <LandingStatItem
        value="150+"
        label="projects"
        description="Over 150 projects successfully delivered."
      />
      <LandingStatItem
        value="9"
        label="team members"
      ...
      <LandingStatItem
        value="300+"
        label="freelancers"
        description="We collaborate with 300+ creative freelancers."
      />
    </div>
  }
>
