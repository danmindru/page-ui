  ...
  previewComponent={
    ...
    >
      <LandingProductCard
        ...
        topComponent={<Badge className="mb-2">New Arrival</Badge>}
      ...
      <LandingProductCard
        ...
        topComponent={<Badge variant="outline" className="mb-2">Bestseller</Badge>}
      ...
      <LandingProductCard
        ...
        topComponent={<Badge variant="secondary" className="mb-2">Limited Edition</Badge>}
        bottomComponent={<div className="mt-2 text-sm font-medium text-green-600">In stock - ships in 24 hours</div>}
