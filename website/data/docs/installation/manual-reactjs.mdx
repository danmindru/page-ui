...
```bash
npm install -D tailwindcss@3 postcss autoprefixer @tailwindcss/forms @tailwindcss/typography tailwindcss-animate embla-carousel-react class-variance-authority clsx tailwind-merge lucide-react @radix-ui/react-accordion @radix-ui/react-tabs
```
...
- [components/shared/ui/input.tsx](https://github.com/danmindru/page-ui/blob/main/components/shared/ui/input.tsx)
- [components/shared/ui/label.tsx](https://github.com/danmindru/page-ui/blob/main/components/shared/ui/label.tsx)
